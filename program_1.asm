...
JEQ 54 R1 R3                  ; x loop "54" is first line out of x loop
LI R0 0 ;edge detection                    ; edge detecition 48 is line of "make dark"
JEQ 48 R2 R0  ; y=0
JEQ 48 R2 R5  ; y=19
JEQ 48 R1 R0  ; x=0
JEQ 48 R1 R5  ; x=19
